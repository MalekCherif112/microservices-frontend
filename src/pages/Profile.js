...
import { onRemoveFromWishlist, onViewProfile, onAddToCart, onRemoveFromCart, onCreateAddress, onPlaceOrder, onGetOrders  } from '../store/actions'
...
const Profile = () => {
    ...
    const { orderDetails } = useSelector(state => state.shoppingReducer);
